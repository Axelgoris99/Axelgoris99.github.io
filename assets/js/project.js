...
const projects = [
  ...
  },
  {
    ...
    description:
      "Setting up a schedule and monitoring the overall progress + individual monitoring (group of 6). Development of interactions with a leap motion in VR",
    tagimg: "",
...
const visuals = [
  {
    title: "Famous Donuts! Part of Blender Guru NFT !",
    cardImage: "assets/images/project-page/donut_fin.png",
  },
  {
    title: "Ice Cream - CG Geek",
    cardImage: "assets/images/project-page/iceCream.png",
  },
  {
    title: "Procedural Hexagonal World",
  ...
  {
    title: "My Room Modelisation",
    cardImage: "assets/images/project-page/karlAppart.png",
  },
  {
    title: "An Apartment Design",
    cardImage: "assets/images/project-page/cycleApartment.png",
  },
  {
    title: "A quick render - 2h",
    cardImage: "assets/images/project-page/canyon.png",
  },
];
const visualcards = document.querySelector(".container2");
// function for rendering project cards data
const showVisuals = () => {
  let output = "";
  visuals.forEach(({ title, cardImage }) => {
    output += `       
      <div class="panel2"
